...
/*cDAT write_test;
    ...
    toto.push_back("Bomberman0.png");
    toto.push_back("BlocDestructible.jpg");
    toto.push_back("BlocNonDestructible.jpg");
    toto.push_back("Sol1.jpg");
    toto.push_back("Sol2.jpg");
    toto.push_back("map.txt");
    toto.push_back("Bombe.png");
    toto.push_back("ExploseCentre.jpg");
    toto.push_back("Explose.jpg");
    toto.push_back("Bomberman0_burn.png");
    toto.push_back("itemNbBombePlus.png");
    toto.push_back("itemPorteePlus.png");
    toto.push_back("itemCoeur.png");
    toto.push_back("itemVitessePlus.png");
    toto.push_back("itemVitesseMoins.png");
    toto.push_back("itemPorteeMoins.png");
    toto.push_back("itemPorteeMax.png");
    toto.push_back("MenuItem.png");
    toto.push_back("itemProtectOwnBomb.png");
    toto.push_back("SolGlace.png");
    toto.push_back("Teleporteur1.png");
    toto.push_back("screenshot.png");
    toto.push_back("Explosion.wav");


    if (!write_test.Create(toto, REPERTOIRE_MAP+"DefaultMap.dat"))
    {
        return EXIT_FAILURE;
    }
    ...
    toto.push_back("Aria.ttf");
    toto.push_back("Blox2.ttf");
    toto.push_back("Contour_CreerPartie.png");
    toto.push_back("Intro.ogg");


    if (!write_test.Create(toto, "Ressources.dat"))
    {
        return EXIT_FAILURE;
    }
